...
//        if (jwd !="" && (jwd.contains("°"))) {//如果不为空并且存在度单位
        jwd = jwd.trim();
//            计算前进行数据处理
...
//        d = new BigDecimal(jwd.contains("°") ? jwd.split("°")[0] : "0");
//        //不同单位的分，可扩展
//        if (jwd.contains("′")) {//正常的′
//            m = new BigDecimal(jwd.contains("′") ? jwd.split("°")[1].split("′")[0] : "0");
...
//        if (jwd.contains("″")) {//正常的″
//            //有时候没有分 如：112°10.25″
//            s = new BigDecimal(jwd.contains("″") ? jwd.split("′")[1].split("″")[0] : "0");
//        } else if (jwd.contains("''")) {//特殊的''
//            //有时候没有分 如：112°10.25''
//            s = new BigDecimal(jwd.contains("″") ? jwd.split("′")[1].split("''")[0] : "0");
//        }
